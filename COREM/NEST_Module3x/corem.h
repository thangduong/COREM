...
class corem : public nest::ArchivingNode
{
public:
  ...
  virtual void set_local_device_id( const nest::index lsdid ) override { local_device_id_ = lsdid; }
  virtual  nest::index get_local_device_id() const override { return local_device_id_; }
...
private:
  ...
  virtual void pre_run_hook() override { }
